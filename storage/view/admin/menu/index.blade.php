...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-header with-border">
                <div class="pull-left">
                    <a href="<?= Tool::urlTo('/admin/menu/edit', ['returnUrl' => Tool::urlTo('/admin/menu/index')]) ?>" class="btn btn-success"><span
                    ...
                    <form role="form" class="form-horizontal" action="" method="get" id="search-form">
                        <div style="margin-right: 5px;" class="pull-left">
                            <input type="text" name="name" class="form-control"
                                   value="<?= $getParams['name'] ?? '' ?>" placeholder="菜单名称" autocomplete="off">
                        </div>
                        <div style="margin-right: 5px;" class="pull-left">
                        ...
                        <div style="" class="pull-left">
                            ...
                            <a href="<?= Tool::urlTo('/admin/menu/index') ?>" class="btn btn-default">清除</a>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <form id="index_form" method="post">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= Tool::urlTo('/admin/menu/edit', ['id' => $value['id']]) ?>"
                                   class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit"></span>
                                    编辑</a>
                                <button link="<?= Tool::urlTo('/admin/menu/delete', ['id' => $value['id']]) ?>" type="button"
